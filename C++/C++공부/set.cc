...
int main(){
    ...
    for (iter = s.begin(); iter != s.end(); ++iter)
    	cout << *iter << " ";	//unordered set. 크기 순으로 정렬(binary tree)
	cout << endl;
	...
	// (~,10]=>10,(10,30]=>30, ... ,(80,90]=>90, (90,~]=>난수(7?)
    iter_upper = s.upper_bound(30);        // 30 원소 마지막의 다음 원소
	// [~,10)=>10,[10,30)=>30, ... ,[80,90)=>90, [90,~)=>난수(7?)
    cout <<"lower_bound(30):"<< *iter_lower << endl;
    cout <<"upper_bound(30):"<< *iter_upper << endl;
    iter_lower = s.lower_bound(55);
    iter_upper = s.upper_bound(55);
    cout <<"lower_bound(55):"<< *iter_lower << endl;
    cout <<"upper_bound(55):"<< *iter_upper << endl;
	...
	cout << *iter_pair.first << endl;	//우선순위 : .이 *보다 높음
